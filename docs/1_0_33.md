...
|         |`GET`|[`/account/{accountId}/call-recording/extensions`](***)|[Beta] Returns the list of extensions to be recorded|
|&#x1F510;|`POST`|[`/account/{accountId}/call-recording/bulk-assign`](***)|[Beta] Creates or updates the list of extensions to be recorded|
