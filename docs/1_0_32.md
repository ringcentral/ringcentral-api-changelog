...
|`GET, PUT`|[`/restapi/v1.0/account/{accountId}/extension/{extensionId}/notification-settings`](https://developers.ringcentral.com/api-docs/latest/index.html#!#RefExtensionNotificationSettings.html)|Retrieval and update of |
