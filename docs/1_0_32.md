...
|         |`POST`|[`/account/{accountId}/greeting`](https://developers.ringcentral.com/api-docs/latest/index.html#!##RefCreateCompanyCustomGreeting)|Upload of custom company greeting|
|&#x1F510;|`POST`|[`/account/{accountId}/ivr-menus`](https://developers.ringcentral.com/api-docs/latest/index.html#!#RefUpdateCompanyAnsweringRule)|Company level call handling rule updating|
