...
|         |`PUT` |[`/account/{accountId}/extension/{extensionId}/address-book/contact/{contactId}`](https://developers.ringcentral.com/api-docs/latest/index.html#!#ReUpdateContact)|`CallSwitch` service feature supported; `AccountDirectory` service feature removed|
